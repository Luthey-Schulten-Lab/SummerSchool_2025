...
| Section | Figures (ordered) | References | Comments |
| --- | --- | --- | --- |
| 1 | initial_state.png, division.ppm, partition.png | Gilbert |  |
| 2 | terminal output |  | Mainly Delta commands. Place part 0 from workshop, here. |
| 3 | sc_growth_composite, g001, g002, rep,  | Gogou | Mainly btree_chromo. Place part 1+2 from workshop, here. |
| 4 | DNA_model_*, DNA_model_composite, looping_summary, topo_example,  | Ryu, Nomidis, Zawadzki | Mainly LAMMPS. Equation for Hamiltonian. Place part 3+4 from workshop, here |
| 5 | directives and code blocks;  |  | Equation for Brownian dynamics. Place things from btree_chromo README, here. |
| 6 | vmd screencaps |  | reference the tcl script |

Outline:

1. Introduction to simulation with btree_chromo and LAMMPS. 
    1. What is the purpose of btree_chromo? What has it been used for in the past (Ben)? What is it currently being used for (Zane, Andrew, Jacob)
2. Running btree_chromo: Setting up on Delta and running your long simulation*
    1. generate initial structure with sc_chain_gen (?) no real reason to
3. Modeling the minimal cell
    1. diagram how program works
    2. some info about how LAMMPS is used
    3. bead representation; brownian dynamics, time scales, time steps
    4. Growing cell, replication
4. Modeling chromosome dynamics. Background: biology (see Jacobs refs, for example, and those from workshop) and modeling in btree_chromo
    1. DNA + interaction hamiltonian
        1. twisting angles
    2. looping+topo
5. Understanding btree_chromo commands
    1. loading various things
    2. minimization
    3. BD
    4. outputting various things
6. Analysis: transfer to laptop for visualization in vmd, plotting RoG
    1. some screencaps
