...
apptainer exec --nv --bind /projects/bddt/$USER/ /projects/bddt/$USER/LM/LM.sif mpirun -np 4 python /projects/bddt/$USER/LM/CME/WholeCellModel/programs/WCM_CMEODE_Hook.py -st cme-ode -t 120 -rs 60 -hi 1 -f "/projects/bddt/"$USER"/LM/CME/WholeCellModel/output_4replicates"
